	...
	inout float3 SHADER_DATA.diffuse_radiance)*/
{
	...
	SHADER_DATA.specular_radiance.xyz= (area_specular * area_specular_contribution + analytical_specular * analytical_specular_contribution + SHADER_DATA.simple_light_diffuse_light) * specular_coefficient * SHADER_DATA.specular_mask * specular_tint;
	...
	float env_multiplyer= specular_coefficient * SHADER_DATA.specular_mask * environment_map_specular_contribution;
	SHADER_DATA.envmap_specular_reflectance_and_roughness= float4(env_multiplyer, env_multiplyer, env_multiplyer, roughness);
	SHADER_DATA.envmap_area_specular_only= area_specular * SHADER_DATA.prt_ravi_diff.z;

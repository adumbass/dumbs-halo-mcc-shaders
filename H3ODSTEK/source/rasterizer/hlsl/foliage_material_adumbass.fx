	...
	inout float3 SHADER_DATA.diffuse_radiance)*/
{
	...
	//float3 diffuse_part= ravi_order_0(SHADER_DATA.bump_normal, sh_lighting_coefficients);
	SHADER_DATA.diffuse_radiance= SHADER_DATA.diffuse_radiance * SHADER_DATA.prt_ravi_diff.x;
	SHADER_DATA.diffuse_radiance= SHADER_DATA.simple_light_diffuse_light + SHADER_DATA.diffuse_radiance;
	SHADER_DATA.specular_radiance= 0.0f;
	
	SHADER_DATA.envmap_specular_reflectance_and_roughness= float4(1.0f, 1.0f, 1.0f, 0.0f);
	SHADER_DATA.envmap_area_specular_only= 0.282094815f * sh_lighting_coefficients[0].xyz;
